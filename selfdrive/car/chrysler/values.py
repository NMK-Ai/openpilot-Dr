...
class CAR:
  # كرايسلر
  PACIFICA_2017_HYBRID = "كرايسلر باسيفيكا هايبرد 2017"
  PACIFICA_2018_HYBRID = "كرايسلر باسيفيكا هايبرد 2018"
  PACIFICA_2019_HYBRID = "كرايسلر باسيفيكا هايبرد 2019"
  PACIFICA_2018 = "كرايسلر باسيفيكا 2018"
  PACIFICA_2020 = "كرايسلر باسيفيكا 2020"
  # جيب
  JEEP_CHEROKEE = "جيب جراند شيروكي V6 2018" # يشمل طراز تريلهوك 2017
  JEEP_CHEROKEE_2019 = "جيب جراند شيروكي 2019" # يشمل طراز تريلهوك 2020
  # رام
  RAM_1500 = "رام 1500 الجيل الخامس"
  RAM_HD = "رام HD الجيل الخامس"

class CarControllerParams:
  def __init__(self, CP):
    self.STEER_STEP = 2  # 50 هرتز
    self.STEER_ERROR_MAX = 80
    if CP.carFingerprint in RAM_HD:
      self.STEER_DELTA_UP = 14
      self.STEER_DELTA_DOWN = 14
      self.STEER_MAX = 361  # القيم الأعلى من ذلك تسبب أخطاء في نظام EPS
    elif CP.carFingerprint in RAM_DT:
      self.STEER_DELTA_UP = 6
      self.STEER_DELTA_DOWN = 6
      self.STEER_MAX = 261  # نظام EPS يسمح بأكثر، يصل إلى 350؟
    else:
      self.STEER_DELTA_UP = 3
      self.STEER_DELTA_DOWN = 3
      self.STEER_MAX = 261  # القيم الأعلى من ذلك تسبب أخطاء في نظام EPS
...
CAR_INFO: Dict[str, Optional[Union[ChryslerCarInfo, List[ChryslerCarInfo]]]] = {
  ...
  CAR.PACIFICA_2018_HYBRID: None,  # نفس المنصة
...
# رسائل CAN الفريدة:
# السيارات الهجينة فقط تحتوي على 270: 8
# سيارات البنزين فقط تحتوي على 55: 8، 416: 7
# بالنسبة للرسالة 564، جميع سيارات 2017 لها طول 4، بينما سيارات 2018-19 لها طول 8.
# بالنسبة للرسالة 924، تحتوي سيارة باسيفيكا 2017 على طول 3، بينما جميع سيارات 2018-19 لها طول 8.
# بالنسبة للرسالة 560، جميع سيارات 2019 لها طول 8، بينما جميع سيارات 2017-18 لها طول 4.

# رسائل جيب جراند شيروكي الفريدة:
# تريلهوك 2017: 618: 8
# بالنسبة للرسالة 924، تحتوي تريلهوك 2017 على طول 3، بينما تحتوي V6 2018 على طول 8.
# بالنسبة للرسالة 560، تحتوي تريلهوك 2017 على طول
...
# جيب جراند شيروكي 2019، بما في ذلك معظم طرازات 2020
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  extra_ecus=[
    (Ecu.hcp, 0x7e2, None),  # يدير ناقل الحركة في السيارات الهجينة
    (Ecu.abs, 0x7e4, None),  # عنوان بديل لنظام ABS في السيارات الهجينة
  ],
)
