...
MAX_POS_INTEGRATOR = 0.2   # متر
MAX_TURN_INTEGRATOR = 0.1  # متر
...
class CarController:
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if CC.enabled and llk_valid:
      # قراءة هذه القيم من عصا التحكم
      # TODO: هذا ليس تسارعًا، أليس كذلك؟
      ...
      # قطع خطأ الزاوية، وهذا يكفي للنهوض من الوقوف
